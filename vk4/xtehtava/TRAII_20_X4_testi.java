package tra2.vk4.xtehtava;// TRAII_20_X4_testi.java SJ

import fi.uef.cs.tra.DiGraph;
import fi.uef.cs.tra.Vertex;
import tra2.vk4.GraphMaker;

import java.util.*;

public class TRAII_20_X4_testi {

    static TRAII_20_X4 testattava = new TRAII_20_X4_tommpuur();
    //                                              ^^^^ oma tunnus tÃ¤hÃ¤n
