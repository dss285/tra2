package tra2.vk5.xtehtava;// TRAII_20_X5_testi.java SJ

import fi.uef.cs.tra.Graph;
import fi.uef.cs.tra.Edge;
import fi.uef.cs.tra.Vertex;
import tra2.vk5.GraphMaker;

import java.util.*;

public class TRAII_20_X5_testi {

    static TRAII_20_X5 testattava = new TRAII_20_X5_tommpuur();
    //                                              ^^^^ oma tunnus tÃ¤hÃ¤n
    ...
    public static void main(String[] args) {
        ...
        ok &= testaaKaikkiPPolutEsim(print);
        if (ok)
