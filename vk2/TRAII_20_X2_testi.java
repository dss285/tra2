package tra2.vk2;// TRAII_20_X2_testi.java SJ
// Testiluokka TRAII 2020 tehtÃ¤viin X2 ja 5-7


import java.util.*;

public class TRAII_20_X2_testi {

    static TRAII_20_X2 testattava = new TRAII_20_X2_tommpuur();
    //                                              ^^^^ oma tunnus tÃ¤hÃ¤n
    ...
    static void testaaX2(Map<Double, Double> M, int print) {
        ...
        long tulos = testattava.containsKeyAika(M);
        ...
        if (print > 0)  // sÃ¤Ã¤dÃ¤ tÃ¤stÃ¤ jos haluat nÃ¤hdÃ¤ paljonko testisi kesti
