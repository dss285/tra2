...
public class TRAII_20_X3_test {
    ...
    public static void main(String[] args) {
        ...
        TRAII_20_X3 testattava = new TRAII_20_X3_tommpuur();
     ...
     */
    static void testaa(TRAII_20_X3 testattava, Queue<Integer> J, int min, int max) {
        System.out.println("Testataan " + J.getClass().getName() + " " + min + ".." + max);
